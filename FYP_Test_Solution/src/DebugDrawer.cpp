...
//{
//	// need to convert from bullet values to ogre values
//	auto colour = Utils::BTOgreVector(color);
//	buildLine(Utils::BTOgreVector(from), Utils::BTOgreVector(to), Ogre::ColourValue(colour.x, colour.y, colour.z, 1.0f));
//	
//}
